                  ...
                  <ul class="solid-bullet-list">
                    <li>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="img-sm rounded-circle image-layer-item" src="http://via.placeholder.com/34x34" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="http://via.placeholder.com/34x34" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="http://via.placeholder.com/34x34" alt="profile"/>
                      </div>
                    </li>
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="http://via.placeholder.com/36x36" alt="profile" class="img-sm rounded-circle"/>
                          </td>
